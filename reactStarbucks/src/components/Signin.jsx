...
const Signin = () => {
  return (
    <div>
        <Navbar />
        <div className=' p-5'>
          <div className=' mx-auto w-[548px] p-5'>
            ...
            <div className='w-full py-5 px-6 rounded-xl shadow-lg'>
              ...
              <div className='flex gap-2 my-4'>
                ...
                <div class="flex items-center">
                  <input checked id="checked-checkbox" type="checkbox" value="" class="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
